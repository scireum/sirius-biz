 ...
 */
public class LookupValueCheck implements ValueCheck {
     ...
     */
    public LookupValueCheck(boolean allowCustomValues) {
        this.allowCustomValues = allowCustomValues;
    }

    @Override
    public void perform(Value value) {
        // Check will be performed by the LookupValue
    }

    @Override
    public String generateRemark() {
        if (allowCustomValues) {
            return NLS.get("LookupValueCheck.remark.allowCustomValues");
        }
        return NLS.get("LookupValueCheck.remark");
    }
}
