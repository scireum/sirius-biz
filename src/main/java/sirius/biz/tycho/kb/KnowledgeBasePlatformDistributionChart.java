...
import sirius.biz.analytics.explorer.PlatformDistributionTimeSeriesComputer;
...
public class KnowledgeBasePlatformDistributionChart extends TimeSeriesChartFactory<Object> {
    @Nullable
    @Override
