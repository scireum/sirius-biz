...
public class Cells {
    ...
    /**
     * Create a cell containing the given value and a sparkline to visualize the longterm trend of it.
     *
     ...
     * @return a HTML string representing the requested cell
     */
     ...
     * @return a HTML string representing the given cell
     */
