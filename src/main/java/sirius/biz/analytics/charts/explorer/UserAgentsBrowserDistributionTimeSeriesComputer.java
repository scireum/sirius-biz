...
/**
 * Helps computing the browser distribution from the user agent data for a given Clickhouse event.
 * <p>
...
public class UserAgentsBrowserDistributionTimeSeriesComputer<O> extends UserAgentsTimeSeriesComputer<O> {
     ...
     */
    public UserAgentsBrowserDistributionTimeSeriesComputer(Function<O, String> queryBuilder) {
        super(queryBuilder);
    }
