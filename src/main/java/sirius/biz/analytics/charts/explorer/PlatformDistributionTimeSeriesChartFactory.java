 ...
 */
public abstract class PlatformDistributionTimeSeriesChartFactory extends UserAgentsTimeSeriesChartFactory {
    @Override
    protected void computers(boolean hasComparisonPeriod,
        ...
        executor.invoke(new PlatformDistributionTimeSeriesComputer<>(getEvent(), (ignored, query) -> getQuery(query)));
    }
}
