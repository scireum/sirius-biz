 ...
 * {@link ReplicationManager#executeReplicationTask(String, String, boolean)} for each task in the batch.
 */
public interface ReplicationTaskStorage {
     ...
     * @param objectId     the id of the original object
     */
    void notifyAboutUpdate(String primarySpace, String objectId);
     ...
     * {@link ReplicationManager#executeReplicationTask(String, String, boolean)}.
     *
