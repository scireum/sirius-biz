...
public class URLBuilder {
     ...
     *
     * @param url     the URL generated by this url builder wrapped as an Optional
     * @param urlType the type of URL that was generated
     */
    public record UrlResult(Optional<String> url, UrlType urlType) {
    }
    ...
    public UrlResult buildUrlResult() {
        if (Strings.isEmpty(blobKey) || (blob != null && Strings.isEmpty(blob.getPhysicalObjectKey()))) {
            if (Strings.isFilled(fallbackUri)) {
                return new UrlResult(Optional.of(createBaseURL().append(fallbackUri).toString()), UrlType.FALLBACK);
            }
    ...
    private UrlResult createPhysicalDeliveryUrlResult() {
        ...
        return new UrlResult(Optional.of(result.toString()), UrlType.PHYSICAL);
    }
