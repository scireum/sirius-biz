...
/**
 * Provides a chart showing the number of {@link GlobalTenantMetricComputer#METRIC_NUM_ACTIVE_TENANTS}.
 */
@Register(framework = Tenants.FRAMEWORK_TENANTS)
@Permission(TenantUserManager.PERMISSION_SYSTEM_TENANT_MEMBER)
public class NumberOfActiveTenantsChart extends TimeSeriesChartFactory<Object> {
    ...
    @Override
    protected void computers(Object ignored,
                             boolean hasComparisonPeriod,
                             boolean isComparisonPeriod,
                             Callback<TimeSeriesComputer<Object>> executor) throws Exception {
        executor.invoke(new MetricTimeSeriesComputer<>(GlobalTenantMetricComputer.METRIC_NUM_ACTIVE_TENANTS));
    }

    @Nonnull
    @Override
    public String getName() {
        return "GlobalNumberOfActiveTenants";
    }
